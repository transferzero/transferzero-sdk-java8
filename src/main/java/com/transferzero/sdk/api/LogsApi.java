...
public class LogsApi {
    ...
    public class APIgetWebhookLogRequest {
         ...
         * @http.response.details
         <table summary="Response Details" border="1">
            ...
            <tr><td> 200 </td><td> Details of requested webhook log </td><td>  -  </td></tr>
    ...
    public class APIgetWebhookLogsRequest {
         ...
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
            <tr><td> 200 </td><td> Webhook logs returned within an array wrapped inside a JSON object </td><td>  -  </td></tr>
            <tr><td> 401 </td><td> Authentication information is missing or invalid. </td><td>  -  </td></tr>
            <tr><td> 500 </td><td> Internal Server Error. </td><td>  -  </td></tr>
         </table>
         */
